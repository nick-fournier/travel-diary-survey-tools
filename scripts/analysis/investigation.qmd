...
DATA_DIR = DATA_DIR / "WeightedDataset_02212025"
...
# Load data
trips_df_raw = pl.read_csv(TRIP_PATH)
households_df = pl.read_csv(DATA_DIR / "hh.csv")
persons_df = pl.read_csv(DATA_DIR / "person.csv")
days_df = pl.read_csv(DATA_DIR / "day.csv")

# Much wow...
trips_df_raw = trips_df_raw.rename({"arrive_second": "arrive_seconds"})
